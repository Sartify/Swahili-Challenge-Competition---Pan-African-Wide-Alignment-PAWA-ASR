...
| **STT** | Inverse Real-Time Factor | 5% | >30 (1 hour audio= 2min transcription)[https://huggingface.co/spaces/hf-audio/open_asr_leaderboard] | higher is better | $s_{\text{IRTF}}=\bigl(\tfrac{\text{IRTF}-30}{3000-\text{IRTF}}\bigr)$ |
