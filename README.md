...
| **STT** | Inverse Real-Time Factor | 5% | >30 (1 hour audio= 2min transcription)[https://huggingface.co/spaces/hf-audio/open_asr_leaderboard] | higher is better | $s_{\text{IRTF}}=\min\!\bigl(1,\;\tfrac{\text{IRTF}}{100}\bigr)$ |
